...
export const schemes = pgTable('schemes', {
    ...
    // Fee Structure
    feeProfitShare: varchar("fee_profit_share", { length: 200 }),
    feeStructure: text("fee_structure"),
    feeFixedAmc: varchar("fee_fixed_amc", { length: 200 }),
    feeVariableAmc: varchar("fee_variable_amc", { length: 200 }),
    feeHurdle: varchar("fee_hurdle", { length: 200 }),
    remarksForFeeStructure: text("remarks_for_fee_structure"),
    
    // Exit Loads
    exitLoad1Yr: varchar("exit_load_1_yr", { length: 200 }),
    exitLoad2Yr: varchar("exit_load_2_yr", { length: 200 }),
    exitLoad3Yr: varchar("exit_load_3_yr", { length: 200 }),
