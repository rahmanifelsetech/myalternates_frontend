...
import { formatCurrency } from './constants/mfDummyData';
import { useMemo, useState } from 'react';
import { useMFPortfolioData } from './hooks/useMfPortfolioData';
...
const IndexOptions: { value: string; label: string }[] = [
...
const MfPortfolio: React.FC = () => {
  ...
  const { summary, investedSchemes, holdings, sectors, transactions, distributionAMC, distributionScheme, distributionAssetClass, marketCapCategory, isLoading } = useTraditionalPortfolioData(selectedInvestmentAccountId || '', 'MF');
  // const { summary, investedSchemes, top5Holdings, top5Sectors, transactions, distributionAMC, distributionScheme, distributionAssetClass, isLoading } = useMFPortfolioData(selectedInvestmentAccountId);
