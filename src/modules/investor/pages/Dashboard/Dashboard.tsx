...
const Dashboard: React.FC = () => {
  // const InvestorDetails = useAppSelector((state) => state.auth).details;
  // const handleAccountChange = (accountId: string) => {console.log('Selected account ID:', accountId); } 
  const navigation = useNavigate()

  useEffect(() => {
    console.log('InvestorDetails in Dashboard:');
    navigation('/investor/portfolio/pms')
  }, []);
