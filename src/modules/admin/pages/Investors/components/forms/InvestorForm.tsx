...
export const InvestorForm: React.FC<InvestorFormProps> = ({ investor, onSubmit, isLoading }) => {
    ...
    useEffect(() => {
        if (investor) {
            reset({
                ...investor,
                name: investor.primaryPerson.fullName ?? '',
                pan: investor.primaryPerson.pan ?? '',
                myaltCode: investor.myaltCode ?? '',
                dateOfBirth: investor.primaryPerson.dob ? formatDate(investor.primaryPerson.dob) : '',
                gender: investor.primaryPerson.gender ?? '',
                mobile: investor.primaryPerson.mobile ?? '',
                email: investor.primaryPerson.email ?? '',
                address1: '',
                address2: '',
                city: '',
                state: '',
                ...
                guardianName: investor.primaryPerson.guardianName ?? '',
                guardianIdType: investor.primaryPerson.guardianIdType ?? '',
                guardianIdNumber: investor.primaryPerson.guardianIdNumber ?? '',
