...
const Input = forwardRef<HTMLInputElement, InputProps>(
  ...
  let inputClasses = ` h-11 w-full rounded-lg border appearance-none px-4 py-2.5 shadow-theme-xs focus:outline-hidden focus:ring-3 ${typographyClasses.component.input} ${typographyClasses.component.placeholder} dark:bg-gray-500 dark:text-grey/90 ${className}`;
